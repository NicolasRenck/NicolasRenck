...
### [API Auth](https://github.com/NicolasRenck/api-auth)
> API REST completa para autenticação e gerenciamento de usuários com JWT, blacklist de tokens, log de acessos por usuário e troca de senha. [🔗 Demo](https://api-auth-bqyh.onrender.com) · [📖 API Docs](https://api-auth-bqyh.onrender.com/api/docs/)
...
### [Event Management](https://github.com/NicolasRenck/event-management)
> Plataforma de gestão de eventos com interface responsiva para organizar e descobrir eventos. CRUD completo, autenticação segura e UI limpa consumindo a API REST. [🔗 Demo](https://event-management-1-3vip.onrender.com)
...
- 💼 [LinkedIn](https://linkedin.com/in/nicolas-renck-75ba74232)
- 📧 nicolas.renck@gmail.com
